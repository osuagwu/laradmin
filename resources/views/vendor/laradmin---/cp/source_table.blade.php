...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item "><a href="{{route('cp-sources')}}">Sources</a></li>
            ...
            <form id="permission-form" onsubmit="updatePermissionString()" class="form-horizontal bg-info"  role="form" method="post" action="{{route('cp-source-permission-update')}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 col-xs-10">
                        <select class="form-control" name="permission_id"  id="permissions-selector" data-source="{{$source}}" size="5" onchange="showPermission()">
