...
<div class="related ">
    <div class="panel panel-primary">
        ...
        <div class="panel-heading"> <h3 class="heading-3 panel-title">Related content</h3></div>
        <div class="panel-body">
            @if($parent)
                <h6 class="heading-6"><a class="parent" href="{{route('page',$parent->post_name)}}"><i class="fas fa-arrow-up"></i> {{$parent->title}}</h6></a>
            @endif
