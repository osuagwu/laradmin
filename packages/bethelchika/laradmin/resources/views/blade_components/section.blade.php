{{-- Use to make a section in content part of a page
    ...
    @endcomponent
--}}
<section class="section section-{{$type??' default '}} @if(isset($isFirst) and $isFirst==true) section-first @endif  @if(isset($isFullHeight) and $isFullHeight==true)section-full-height @endif {{$class??''}}">
    <div class="container">
