...
@push('meta')
<!--Social media metas-->
 <meta property="article:author" content="{{config('services.facebook.page_url','https://www.facebook.com/'.config('app.name', 'Laradmin'))}}">
 ...
 <meta name="twitter:site" content="{{'@'}}{{$metas['twitter_site']?? config('services.twitter.handle','laradmin')}}">
 <meta name="twitter:title" content="{{$metas['title']}}">
 <meta name="twitter:description" content="{{$metas['description']}}">
 <meta name="twitter:creator" content="{{'@'}}{{$metas['twitter_creator']?? config('services.twitter.handle','laradmin')}}">
 @if(isset($metas['image']))
