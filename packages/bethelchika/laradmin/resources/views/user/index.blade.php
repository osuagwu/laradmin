...
@component('laradmin::blade_components.section',['type'=>'subtle','class'=>'extra-padding-bottom'])
                ...
                <div class="blog-posts blog-posts-h0" >
                    @if($posts->count())
                        @foreach($posts as $post)
                            @include('laradmin::user.partials.wp.blog_post',['post'=>$post,'class'=>'flat blog-post-sm v0','summary'=>1])
                        @endforeach
                    @else
