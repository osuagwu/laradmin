...
@section('content')
<section class="section section-warning  section-last  section-full-page section-diffuse section-light-bg section-diffuse-no-shadow">
    <div class="container">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{route('re-auth')}}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a href="{{route('user-security')}}" class="btn btn-warning">Cancel</a>
