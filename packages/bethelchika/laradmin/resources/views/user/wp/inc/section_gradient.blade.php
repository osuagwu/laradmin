{{---
    ...
    */
    ...
    [INPUTS]
    $page \BethelChika\WP\Models\Page | Corcel\Model\Page If given all the other inputs will be read from this object.
    OR
...
if(isset($page) and $page){
    $scheme=$page->meta->scheme;
    $brand2=$page->meta->linear_gradient_brand2??null;
    $fainted=$page->meta->linear_gradient_fainted??null;
    $direction=$page->meta->linear_gradient_direction;
}
