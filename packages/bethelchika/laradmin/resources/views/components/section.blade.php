{{-- Use to make a section in content part of a page
    ...
    USAGE:
    @component('laradmin::components.section',['type'=>'info','body'=>'body','title'=>'Title','legend'=>'legend'])
    @endcomponent

    @component('laradmin::components.section',['type'=>'info','title'=>'Title','legend'=>'legend'])
    slot
    @endcomponent

    @component('laradmin::components.section',['type'=>'info','title'=>'Title','legend'=>'legend','isFirst'=>true,'isFullHeight'=>true])
    slot
    @endcomponent
--}}
