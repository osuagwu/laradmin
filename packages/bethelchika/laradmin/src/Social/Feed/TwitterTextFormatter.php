 ...
 * @source https://github.com/netgloo/php-samples/blob/master/php-twitter-text-formatter/TwitterTextFormatter.php
 * @todo Once the use of this code is stabilised we should perhaps require it through composer? But note we have made small modification (search for Bethel or see the github issues)
 */
class TwitterTextFormatter
{
    ...
    private static function parse_tweet_text($tweet, $configs)
    {
        ...
        $text = $tweet->text??$tweet->full_text;// Bethel 11/Aug/2019 13:30. Added '??$tweet->full_text'
