...
class AddLaradminUserFields extends Migration
{
    ...
    public function down()
    {
        ...
        //TODO: b/c its hard to tell if we actually added the fileds(as they may have been added before)we will not do to many droppings here. Consequently we may not be performing clean uninstall of the fields we added
        Schema::table('users', function (Blueprint $table) {
